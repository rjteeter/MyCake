...
class User 
{
  public $user_active = 0;
	...
	function __construct($user,$display,$pass,$email,$garage,$cash)
	{
		...
		$this->garage_name = sanitize($garage);
		$this->usr_cash = sanitize($cash);
	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("sssssiisi", $this->username, $this->displayname, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active, $this->garage_name, $this->usr_cash); 
				$stmt->execute();
